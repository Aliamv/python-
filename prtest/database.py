...
def connect_database():
    ...
    try:
        conn =  pymysql.Connect(host='localhost', user='root', password='victor.1383')
        mycursor = conn.cursor()
    except Exception as e:
       messagebox.showerror('Error', f'something went wrong! check mySQL connection: {e}')
       print(e)
       return
